namespace MonsterModels
{
    public class MonsterCreation
    {
        ...
        public static MonsterCreation goblin = new MonsterCreation("Goblin", 20, 3, 2, 1,
            50, 50, 5);
        ...
        public MonsterCreation(string name, int health, int damage, int armor, int level, int experience, int gold, int strength)
        {
            Name = name;
            Health = health;
            Damage = damage;
